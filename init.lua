...
local function parseLine(line)
  logger.Info(line)
  repository.dialogue_log.insert(mq.TLO.Target.ID(), mq.TLO.Target.Name(), mq.TLO.Target.CleanName(), mq.TLO.Target.X(), mq.TLO.Target.Y(), mq.TLO.Target.Z(), mq.TLO.Zone.ID(), mq.TLO.Zone.ShortName(), state.currentKeyword, line:gsub("'", "''"))
